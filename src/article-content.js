...
function article({ slug, title, date, summary, body = temporaryArticleBody, index }) {
  ...
  return Object.freeze({
    ...
    title,
    // The user-selected provisional publish date is fixed per article and shared by both views.
    meta: Object.freeze([date, `${articleReadMinutes(normalizedBody)} MIN`]),
    summary,
    body: normalizedBody,
    media: Object.freeze({
...
export const ALL_ARTICLE_DETAILS = Object.freeze([
  article({
    ...
    date: "May 1st 2026",
    summary: "How a working agent harness uses bounded delegation, explicit checks, visible failure states, and honest cost accounting to make uncertain behavior easier to inspect.",
  ...
  article({
    ...
    date: "Jan 10th 2024",
    summary: "A personal account of professional loss, family crisis, survival, and choosing integrity when the industry turns hostile, and why continuing to make the work matters.",
  ...
  article({
    ...
    date: "May 9th 2026",
    summary: "How AI products accumulate intent debt when they misread users, assume missing context, and make correction difficult, plus ways design teams can identify and prevent it.",
  ...
  article({
    ...
    date: "Apr 29th 2024",
    summary: "What a two-dollar agent mistake revealed about cost visibility, failure states, operational trust, and why autonomous systems must demonstrate control before earning more freedom.",
  ...
  article({
    ...
    date: "Nov 3rd 2024",
    summary: "Why designers need evals to define product quality, expose weak and inconsistent outputs, and keep AI experiences useful, clear, trustworthy, and accountable over time.",
  ...
  article({
    ...
    date: "Jan 14th 2026",
    summary: "A practical framework for deciding what an early product should cut, defer, or build when ambition outruns time and budget, and research must separate evidence from enthusiasm.",
  ...
  article({
    ...
    date: "Oct 3rd 2025",
    summary: "How research-grounded design principles resolve real product trade-offs, survive delivery pressure, and endure when encoded in workflows, interfaces, and structure.",
  ...
  article({
    ...
    date: "Jul 13th 2025",
    summary: "Lessons in research, workflow structure, delivery, and coherence from embedding with product teams across complex commercial projects and organizational change.",
  ...
  article({
    ...
    date: "Aug 27th 2026",
    summary: "How treating severe constraints as the brief can clarify the real problem, expose the limits of familiar patterns, and produce a product for the user's actual state.",
  ...
  article({
    ...
    date: "Jul 12th 2025",
    summary: "Why a real MVP is not the smallest demo, but the smallest complete journey a user can finish confidently, especially when trust, context, and user state shape viability.",
    body: realMvpBody,
  }),
