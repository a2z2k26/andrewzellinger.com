...
[Historical records](archive/README.md) preserve prior audits, experiments, source material, screenshots and handoffs. They are dated evidence, not a description of every current behavior. The complete prior [agent decision log](archive/agent-decisions.md) remains available for design-specific context.
